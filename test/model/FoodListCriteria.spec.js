...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('FoodListCriteria', function() {
      beforeEach(function() {
        instance = new FoodDataCentralApi.FoodListCriteria();
      });

      it('should create an instance of FoodListCriteria', function() {
        // TODO: update the code to test FoodListCriteria
        expect(instance).to.be.a(FoodDataCentralApi.FoodListCriteria);
      });
