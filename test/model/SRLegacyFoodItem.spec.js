...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SRLegacyFoodItem', function() {
      beforeEach(function() {
        instance = new FoodDataCentralApi.SRLegacyFoodItem();
      });

      it('should create an instance of SRLegacyFoodItem', function() {
        // TODO: update the code to test SRLegacyFoodItem
        expect(instance).to.be.a(FoodDataCentralApi.SRLegacyFoodItem);
      });
