...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('MeasureUnit', function() {
      beforeEach(function() {
        instance = new FoodDataCentralApi.MeasureUnit();
      });

      it('should create an instance of MeasureUnit', function() {
        // TODO: update the code to test MeasureUnit
        expect(instance).to.be.a(FoodDataCentralApi.MeasureUnit);
      });
