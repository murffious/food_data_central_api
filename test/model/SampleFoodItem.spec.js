...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SampleFoodItem', function() {
      beforeEach(function() {
        instance = new FoodDataCentralApi.SampleFoodItem();
      });

      it('should create an instance of SampleFoodItem', function() {
        // TODO: update the code to test SampleFoodItem
        expect(instance).to.be.a(FoodDataCentralApi.SampleFoodItem);
      });
